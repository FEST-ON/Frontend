...
export const surveyQuestions: SurveyQuestion[] = [
  { id: "q1", question: "오늘 축제는 전반적으로 만족스러우셨나요?", type: "rating" },
  { id: "q2", question: "가장 만족한 프로그램은 무엇인가요?", type: "choice", options: ["공연", "체험", "푸드", "전시"] },
  { id: "q3", question: "친환경(다회용기·분리배출) 캠페인에 참여하셨나요?", type: "choice", options: ["참여함", "참여 안 함", "다음엔 참여할게요"] },
];
...
export async function fetchSurveyQuestions() {
  return delay(surveyQuestions, 300);
}
