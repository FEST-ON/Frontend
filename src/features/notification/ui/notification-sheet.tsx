...
export function NotificationSheet() {
  ...
  return <Sheet>
    <SheetTrigger render={<Button variant="outline" size="icon" className="relative rounded-full" aria-label={`알림 ${unreadCount}개`} />}>
      <Bell className="size-4" />{unreadCount > 0 && <span className="absolute right-1.5 top-1.5 size-1.5 rounded-full bg-destructive" />}
    </SheetTrigger>
